  ...
  <li class="menu_right" style="margin-right: 15px; float:right"><a href="#" class="drop">Accounts</a><!-- Begin 3 columns Item -->
      ...
      <div class="dropdown_3columns align_right"><!-- Begin 3 columns container -->
          ...
          <div class="col_3">
			  ...
			  <p align="center"><a href="lol.php">My Profile</a></p>
  ...
  <?php
			   include('config.php');			
					$commentid=$_GET['id'];
			  		...
			  		echo '<img src="'.$row3['coverphoto'].'" height="250px" width="838px" style="border-width: 0px;">';
...
$result = mysql_query("SELECT * FROM friends WHERE requested='".$_GET['id']."' and status='accepted' ORDER BY requested ASC");
	...
	?>
		    <a rel="facebox" href="listfriends.php?id=<?php echo $_GET['id']; ?>" style="text-decoration:none; color:#FFFFFF;">friends</a>  </div>
	    friends</div>
	</div>
...
<div class="item" style="height: 147px">
    ...
    <div class="tabs">
       ...
       <div class="tab">
           ...
           <div class="content">
               <form action="savecommentprof.php" method="post">
			  	<input name="from" type="hidden" value="<?php echo $_SESSION['SESS_MEMBER_ID']; ?>">
			  	<input name="to" type="hidden" value="<?php echo $_GET['id']; ?>">
			  	<input name="pakadtoan" type="hidden" value="<?php echo $_GET['id']; ?>">
       ...
       <div class="tab">
           ...
           <div class="content">
               <form action="postphotoprof.php" method="post" enctype="multipart/form-data">
				<input name="from" type="hidden" value="<?php echo $_SESSION['SESS_MEMBER_ID']; ?>">
				<input name="to" type="hidden" value="<?php echo $_GET['id']; ?>">
				Select Image
				<br>
...
$fre=$_GET['id'];
								...
								$result3 = mysql_query("SELECT * FROM comment where pakadtoan='$fre' or name='$fre' ORDER BY id DESC");
...
$result = mysql_query("SELECT * FROM subcomment where subcommentid='$rrr'");
	...
	echo $numberOfRows.'     '; 
		...
		$result4 = mysql_query("SELECT * FROM subcomment where subcommentid='$rrr'");
			...
			{
			echo '<img src="'.$row5['profilepic'].'" style="max-width: 50px">';
			//echo '<div style="float: right; padding-top: 1px; padding-bottom: 1px; padding-right: 1px; width: 328px;">';
			echo '<a style="text-decoration:none" href=profile.php?id='.$row3["commentid"] .'>'.$row5['fname'].' '.$row5['lname'].'</a>'.'   '.$row4['content'];
			//echo '</div>';
			}
			echo '</div>';					
			}					
